// STUB
// Placeholder for shot 07 'verify' (illustrated). The scene agent replaces this whole file.
FILM.scene({
  id: 'verify',
  draw(ctx, t, info) {
    ...
    L.text(ctx, info.shot.title || 'verify', 540, 1420, { size: 44, align: 'center', color: P.ink });
    L.text(ctx, 'verify', 540, 1480, { size: 30, align: 'center', color: P.inkSoft });
