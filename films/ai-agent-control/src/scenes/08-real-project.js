// STUB
// Placeholder for shot 08 'real-project' (illustrated). The scene agent replaces this whole file.
FILM.scene({
  id: 'real-project',
  draw(ctx, t, info) {
    ...
    const seed = L.hash('real-project');
    L.paper(ctx);
    ...
    L.text(ctx, info.shot.title || 'real-project', 540, 1420, { size: 44, align: 'center', color: P.ink });
    L.text(ctx, 'real-project', 540, 1480, { size: 30, align: 'center', color: P.inkSoft });
