// STUB
// Placeholder for shot 10 'cta' (illustrated). The scene agent replaces this whole file.
FILM.scene({
  id: 'cta',
  draw(ctx, t, info) {
    ...
    L.text(ctx, info.shot.title || 'cta', 540, 1420, { size: 44, align: 'center', color: P.ink });
    L.text(ctx, 'cta', 540, 1480, { size: 30, align: 'center', color: P.inkSoft });
